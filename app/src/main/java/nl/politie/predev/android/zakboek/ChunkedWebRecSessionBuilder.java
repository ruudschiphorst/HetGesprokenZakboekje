...
//
//	public ChunkedWebRecSessionBuilder(Context context, Bundle extras, ComponentName callingActivity, SharedPreferences settings) throws MalformedURLException {
//		mContext = context;
//
//        if (extras == null) {
//            extras = new Bundle();
...
//		mDeviceId = settings.getString(PreferencesActivity.PREFS_UNIQUE_ID,"");  //PreferenceUtils.getUniqueId(prefs);
//		mContentId = settings.getString(PreferencesActivity.PREFS_CONTENT_ID,"");		//PreferenceUtils.getUniqueId(prefs, "content-id");
//		mAccountName = settings.getString(PreferencesActivity.PREFS_USERNAME, "");
...
//
//		mPartialResults = true;//extras.getBoolean(RecognizerIntent.EXTRA_PARTIAL_RESULTS);
//
...
//
//        Log.i("phase 1 " + urlServer + " :: " + extras.getString(Extras.EXTRA_SERVER_URL) + " :: " + wrapper.getServerUrl());
...
//			return "audio/x-flac";
//		} else if ("audio/x-mp4a-latm".equals(mime)) {
//			return "audio/x-mp4a-latm";
//		} else if ("audio/x-wav".equals(mime)) {
//			return "audio/x-wav";
//		}
