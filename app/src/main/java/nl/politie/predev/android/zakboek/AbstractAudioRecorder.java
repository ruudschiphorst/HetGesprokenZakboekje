...
public abstract class AbstractAudioRecorder implements AudioRecorder {
    ...
    protected SpeechRecord createRecorder(int audioSource, int sampleRate, int bufferSize) {
        ...
        mRecorder = new SpeechRecord(audioSource, sampleRate, AudioFormat.CHANNEL_IN_MONO, RESOLUTION, bufferSize, true, true, true);
...
//        Log.i("Pause score: " + pauseScore);
    ...
    public float getRmsdb() {
        ...
        if (rootMeanSquare > 1) {
            // TODO: why 10? - because it is voltage, use 20 for powerdB
    ...
    public float getDuration() {
        return (float) mBytesSinceStart/mSamplesInOneSec;
    }
